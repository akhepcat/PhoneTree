...
CREATE TABLE users (
    ...
    email UUID,			# [PRIVATE]: uuid reference to the user's email address
    PRIMARY KEY(userid)
);
...
CREATE TABLE emails (
    email UUID,			# INTERNAL: uuid of the email account
...
CREATE TABLE groups (
    group UUID,			# INTERNAL: uuid of the group
...
CREATE TABLE membership (
    group UUID,			# [SHARED]: uuid reference to a group
